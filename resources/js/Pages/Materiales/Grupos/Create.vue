    ...
    <app-layout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                ...
                > 
                <inertia-link :href="route('materiales.index', [institucion_id, division.id])">Materiales</inertia-link>
                 > Nuevo grupo
            </h2>
        </template>
...
<script>
    ...
    export default {
        ...
        methods: {
            submit() {
                this.$inertia.post(this.route('materiales.store', [this.institucion_id, this.division.id]), this.form)
            },
