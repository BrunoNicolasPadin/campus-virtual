            ...
            <titulo-lista>
                ...
                <template #detalles>
                    ...
                    <detalles-tutorial id="eliminarte">
                        ...
                        <template #contenido-video>
                            <a :href="'../https://gescol.s3-sa-east-1.amazonaws.com/Tutoriales/Directivo/Eliminar.png'" target="_blank">
                                <img :src="'../https://gescol.s3-sa-east-1.amazonaws.com/Tutoriales/Directivo/Eliminar.png'" class="border" alt="Eliminar" title="Eliminar" />
                            </a> <br>
                        </template>
                    </detalles-tutorial>
