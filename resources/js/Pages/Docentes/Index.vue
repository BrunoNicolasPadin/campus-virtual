    ...
    <app-layout>
        <template #header>
            <span class="font-semibold text-md text-gray-800 leading-tight">
                <inertia-link class="hover:underline" :href="route('roles.index', institucion_id)">Roles</inertia-link> / Docentes
            </span>
        </template>
                ...
                <template #tabla>
                    ...
                    <table-body>
                        <template #tr>
                            ...
                            <tr v-for="(docente, index) in docentes.data" :key="docente.id">
                                <table-data>
                                    <template #td>
                                        {{ index + 1 }}
                                    </template>
                                ...
                                <table-data >
                                    <template #td v-if="docente.foto">
                                        <img class="block m-auto p-auto h-20 w-20 object-cover" :src="'../../storage/' + docente.foto "  alt="Foto de perfil" />
                                    </template>
        ...
        methods: {
            ...
            buscar() {
                if (this.nombre == '') {
                    ...
                    this.$inertia.replace(this.route('buscador-de-docentes', {institucion_id: this.institucion_id, nombre: this.nombre}))
                }
            }
        }
    }
