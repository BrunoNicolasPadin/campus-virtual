    ...
    <app-layout>
        <template #header>
            <h3 class="font-semibold text-gray-800 leading-tight">
                ...
                > 
                <inertia-link :href="route('anotados.show', [institucion_id, division.id, asignatura.id, mesa.id, anotado.id])">Entrega de {{ anotado.alumno.user.name }}</inertia-link>
                > Agregar correccion/es
            </h3>
        </template>
