        ...
        <template #header>
            <h3 class="font-semibold text-gray-800 leading-tight">
                ...
                <inertia-link :href="route('mesas.show', [institucion_id, division.id, asignatura.id, mesa.id])">Mesa del {{ mesa.fechaHora }}</inertia-link>
                    > Calificar a {{ anotado.alumno.user.name }}
            </h3>
        </template>
                    ...
                    <form method="post" @submit.prevent="submit">
                        ...
                        <div class="-mx-3 md:flex mb-6">
                            <div class="md:w-full px-3 mb-6 md:mb-0">
                                ...
                                <info>
                                    <template #info>
                                        Se puede dejar vacio, poner cualquier numero con coma (ponga un punto en vez de la coma) o con 'Aprobado' y 'Desaprobado'.
                                    </template>
                                </info>
                            </div>
                        </div>
