                    ...
                    <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-5 sm:px-6 md:mt-5 lg:mt-5 lg:px-8 xl:mt-5">
                        <div class="text-center">
                            ...
                            <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl">
                                Conecta a tus directivos, docentes, alumnos, padres y madres en un solo lugar y permití que accedan a la información relacionada a 
            ...
            <div class="py-5">
                ...
                <div class="pt-6 pb-8 px-4 sm:px-8 my-2 mb-4">
                    <p class="mt-3 text-gray-900 leading-loose">
                        ...
                        un sitio web en el cual podrán ir digitalizando poco a poco los procesos que hoy en día hacen en papel o en tablas Excel o WhatsApp y 
