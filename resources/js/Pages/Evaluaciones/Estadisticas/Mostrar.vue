        ...
        <div class="py-6">
            ...
            <estructura-tabla>
                <template #tabla>
                    ...
                    <table-body>
                        <template #tr>
                            <tr v-for="(mejorNota, index) in numerosArray.mejoresNotas" :key="mejorNota.id">
                                <table-data>
                                    <template #td>
                                        {{ index + 1 }}
                                    </template>
                                ...
                                <table-data>
                                    <template #td>
                                        <inertia-link class="hover:underline" :href="route('entregas.show', [institucion_id, division.id, evaluacion.id, mejorNota.id])">
                                            Ingresar
                                        </inertia-link>
                                    </template>
                                </table-data>
