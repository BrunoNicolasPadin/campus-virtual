...
<div>
    <div class="min-h-screen bg-blue-50">
        ...
        <div class="md:flex flex-col md:flex-row md:min-h-screen w-full">
            <div @click="open = false" class="border-r-2 border-r-black border-t-2 border-t-black flex flex-col w-full md:w-64 text-gray-700 bg-blue-50 dark-mode:text-gray-200 dark-mode:bg-gray-800 flex-shrink-0" x-data="{ open: false }">
