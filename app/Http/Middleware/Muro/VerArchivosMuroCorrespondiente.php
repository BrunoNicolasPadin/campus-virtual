...
class VerArchivosMuroCorrespondiente
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        if (session('tipo') == 'Alumno' || session('tipo') == 'Padre') {
            ...
            abort(403, 'No puedes ver los archivos de una publicacion hecha en una division de la que no formas parte.');
        }
        ...
        if (session('tipo') == 'Institucion' || session('tipo') == 'Directivo') {
            ...
            abort(403, 'Estos archivos no forma parte de la institucion de la que perteneces.');
        }
